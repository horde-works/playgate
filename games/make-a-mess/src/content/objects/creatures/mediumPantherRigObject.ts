...
export const MEDIUM_PANTHER_POSES: readonly CreaturePoseContract<MediumPantherPoseId>[] = [
  ...
  },
  {
    ...
    rootTranslation: point(0, -0.18, -0.04),
    boneRotations: {
      pelvis: point(-0.55, 0, 0), lumbar: point(0.08, 0, 0), chest: point(0.05, 0, 0),
      neck: point(0.27, 0, 0), head: point(0.15, 0, 0),
      "left-scapula": point(0.66, 0, 0), "left-forearm": point(0.1, 0, 0), "left-carpus": point(0.15, 0, 0),
      "right-scapula": point(0.66, 0, 0), "right-forearm": point(0.1, 0, 0), "right-carpus": point(0.15, 0, 0),
      "left-hip": point(0.15, 0, 0), "left-knee": point(0.6, 0, 0), "left-hock": point(-0.5, 0, 0),
      "right-hip": point(0.15, 0, 0), "right-knee": point(0.6, 0, 0), "right-hock": point(-0.5, 0, 0),
      "tail-0": point(-0.16, 1.15, 0), "tail-1": point(-0.09, 0.45, 0), "tail-2": point(-0.15, 0.45, 0),
      "tail-3": point(-0.41, 0.45, 0), "tail-4": point(-0.4, 0.45, 0), "tail-5": point(-0.22, 0.35, 0),
      "tail-6": point(-0.34, 0.25, 0),
    },
    contactPartIds: standingContacts, grounded: true, phase: "observe",
...
export const mediumPantherPoseAtlasObject: CreatureLabModel = {
  ...
  revision: "panther-rig-m3-2026-08-14",
  ...
  sourceNotes: [
    ...
    "Perch observation uses a high feline sit: folded hindquarters, vertical forelimb supports, level muzzle and a grounded tail curl around the far hip.",

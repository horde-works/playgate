...
function compilePiece(
  ...
  const piece: BreakablePieceDefinition = {
    ...
    intactCollisionRole: source.intactCollisionRole,
    color,
    ...
    maximumVerticalGap: source.maximumVerticalGap,
...
function primitiveSource(object: Extract<SceneObjectDefinition, { kind: "primitive" }>): ScenePrefabPieceDefinition {
  return {
    ...
    intactCollisionRole: object.intactCollisionRole,
    color: object.color,
    ...
    maximumVerticalGap: object.maximumVerticalGap,
    hinge: object.hinge,
    actuator: object.actuator,
    light: object.light,
    textureProfile: object.textureProfile,
    landscapeSurface: object.landscapeSurface,
    treeVisual: object.treeVisual,
    vegetationVisual: object.vegetationVisual,

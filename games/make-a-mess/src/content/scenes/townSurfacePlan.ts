...
export const townSurfaceRoutes: readonly TownSurfaceRoute[] = [
  ...
  {
    id: "west-wood-path",
    purpose: "Продолжение главной улицы: тропа сквозь опушку мимо причала в туман",
    points: [[-11.8, -12.2], [-15.4, -12.0], [-17.4, -11.4], [-19.6, -10.8], [-22.0, -9.9], [-24.6, -9.6], [-26.4, -10.0]],
    width: 1.3,
    dirt: 0.95,
    wetness: 0.6,
  },
  ...
  },
  {
    ...
    purpose: "Прогулочная тропа с южной улицы прогалом между к4 и к5 в луга, затухает",
    points: [[12.8, -33.6], [12.5, -38.0], [12.5, -42.5], [10.0, -46.0], [7.6, -50.2], [7.0, -54.0]],
    width: 0.55,
    dirt: 0.42,
    wetness: 0.46,
  },

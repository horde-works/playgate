...
/**
 * Клан VX-8 «Yaqui». Отдельная сторона, а не Tonkawa, и это ПЕРЕСМОТР: машину
 * заводили как вторую машину полигона, потому что полигон один и хозяин один.
 *
 * Пересмотрено потому, что «стоят на одном поле» и «одна сторона» — разные
 * утверждения, а вооружение у обеих настоящее. Две машины на одном полигоне
 * из разных кланов — это испытание, ради которого полигон и существует; две
 * машины одной стороны, летающие мимо друг друга с боевым оружием, — это
 * просто невыстрелившая декорация.
 */
export const YAQUI_ALLEGIANCE: VehicleAllegiance = "yaqui";

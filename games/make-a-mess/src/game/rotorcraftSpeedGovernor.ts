...
export const DEFAULT_SLIP_POLICY: RotorcraftSlipPolicy = {
  // Двадцать два градуса — машина заметно валит боком в вираже и читается
  // быстрой; меньше десяти выглядит аккуратно и вяло.
  enRoute: (22 * Math.PI) / 180,
  // На заходе занос почти запрещён: створ требует прийти В ПОЛОЖЕНИИ, а не
  // просто в точке, и крабом в стакан не попасть.

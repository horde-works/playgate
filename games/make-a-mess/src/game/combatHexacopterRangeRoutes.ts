...
const circuitNodes: readonly { id: string | null; position: SceneVector3 }[] = [
  ...
  namedPoint("immelmann-final", 80, 82),
  ...hairpin([80, 82], [60.8, 96.4], 12, [106, 144]).slice(1, -1).map(plainPoint),
  namedPoint("final-rejoin", 60.8, 96.4),
  plainPoint([32, 0, 62]),
...
const ALTITUDE_KEYS: readonly (readonly [number, number])[] = [
  [0, 20],
  [nodeFraction("clear"), 26],
  [nodeFraction("departure-complete"), 34],
  [nodeFraction("backaway"), 40],

  ...
  for (const side of [-1, 1] as const) {
    ...
    for (let post = 0; post < 5; post += 1) {
      ...
      builder.add(
        ...
        // Настил галереи — встык по шагу стоек (2.35). Стояло 2.42: щиты
        // лезли друг на друга на 70 мм, и низ настила спорил за пиксели по
        // всей длине — а низ здесь и есть потолок прохода под галереей.
        [2.35, 0.2, 2.1],

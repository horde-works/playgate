...
Общая граница тела, вида, профиля и мира, законы continuous motion, контакта,
поведения и текущий статус runtime собраны в
[`../living-creatures-lessons.md`](../living-creatures-lessons.md).
...
Runtime-коррекции полной мембраны и причинного воздушного поворота среднего
дракона записаны в `discrepancy-log-dragon-runtime-m5.md`.

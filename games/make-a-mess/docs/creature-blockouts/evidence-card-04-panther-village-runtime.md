...
- `sit-observe` опускает таз на сложенные задние конечности, поднимает грудь
  на почти вертикальных передних цепях и компенсирует наклон позвоночника
  шеей: морда смотрит в горизонт, а не в камень; хвост лежит тихой дугой
  вокруг дальней стороны таза вместо длинного свободного рычага;
...
M7 исправил визуально отвергнутый силуэт `sit-observe`, не меняя принятую P4
геометрию. В старой позе грудь оказывалась ниже таза, а передние цепи были
сложены. Теперь грудь выше таза более чем на `0.24 m`, четыре сустава каждой
передней опоры идут сверху вниз в одной почти вертикальной плоскости, локальный
наклон головы компенсирует позвоночник до горизонтальной морды. Восьмисегментный
хвост возвращается к тазу дугой и остаётся над опорной поверхностью. Эти признаки
закреплены как численная regression и отдельный Object Lab PNG.

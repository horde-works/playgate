...
- Runway: 176 × 14 m on z = -22 m, with 7 m threshold insets, centreline, edge lines, threshold bars, aiming points, edge lamps, opposed red/green threshold faces and a transverse PAPI bar for each approach.
- Apron: 76 × 19 m with three marked stands; a 12 m taxiway joins it to the runway.
- Terminal: 52 × 20 m, eight 6.5 m structural bays, 6.3 m wall line and 6.59 m roof line.
...
- Supporting systems: integrated control tower, maintenance hangar, three-bay rescue station, bunded fuel farm, continuous security boundary with a service gate, landside loop, two parking courts and physical lighting.
...
- Landside circulation may reach the apron only through the terminal's controlled routes; the end fences close against the riprap belt.
...
- Initial unsupported pieces, grass crossing paved operational areas, hardstanding outside the shoreline, a bypass around security, or either public route failing in either direction.
